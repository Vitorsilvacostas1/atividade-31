...
INSERT INTO AGENCIA VALUES (0562, 'Rua Joaquim Teixeira Alves, 1555', 4), (3153, 'Av. Marcelino Pires, 1960', 1);

INSERT INTO CLIENTE VALUES ('111.222.333-44', 'Jennifer B Souza', 'F', 'Rua Cuiabá, 1050'), 
                           ('666.777.888-99', 'Caetano K Lima', 'M', 'Rua Ivinhema, 879'), 
                           ('555.444.777-33', 'Silvia Macedo', 'F', 'Rua Estados Unidos, 735');

INSERT INTO CONTA VALUES ('86340-2', 763.05, 2, 3153), ('23584-7', 3879.12, 1, 0562);
...
SELECT Cpf, Endereco FROM CLIENTE WHERE Nome = 'Caetano K Lima';


SELECT Numero_agencia, Endereco FROM BANCO, AGENCIA WHERE Nome = 'Banco do Brasil' AND Codigo = Cod_banco;
